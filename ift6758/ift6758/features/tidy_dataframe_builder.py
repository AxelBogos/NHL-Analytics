...
class DataFrameBuilder:
    ...
    def parse_penalty_data_ongoing(self, json_data, home_strength = 5, away_strength = 5, homepenaltylist = [], awaypenaltylist = [],
                                   homemajorlist = [], awaymajorlist = [], homepenaltystart = None, awaypenaltystart = None, start_event = 0,first_run = True) -> list:
    ...
    def make_penalty_dataframe(self) -> pd.DataFrame:
        ...
        result2 =result.drop_duplicates(subset=["game_id", "game_time"], keep="last")
        #print('Save CSV...')
