...
with experiment.context_manager("Distance LogReg"): 
    ...
    experiment.add_tag('3-1 Dist LogReg')
    experiment.log_model('3_1_dist_logreg__model', file_name)
...
with experiment.context_manager("Random Baseline"): 
    ...
    experiment.log_parameters(params)
    experiment.log_metrics(metrics)
    experiment.add_tag('3-2 Random Baseline')
...
with experiment.context_manager("shot_angle_logreg"): 
    ...
    experiment.log_parameters(params)
    experiment.log_metrics(metrics)
    experiment.add_tag('3-3 Angle LogReg')
    experiment.log_model('3_3_angle_logreg__model', file_name)
...
with experiment.context_manager("shot_angle_dist_logreg"): 
    ...
    experiment.log_parameters(params)
    experiment.log_metrics(metrics)
    experiment.add_tag('3-3 Angle Dist LogReg')
    experiment.log_model('3_3_angle_dist_logreg__model', file_name)
