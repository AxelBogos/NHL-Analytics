...
api = API(api_key='ROQRzoNIWml3dvuA8oZTv2xGc')
...
lgbm = pickle.load(open('6-LGBM.pkl','rb'))
nn = pickle.load(open('tuned_nn_model.pkl','rb'))
xgb = pickle.load(open('tuned_xgb_model.pkl','rb'))
logreg = pickle.load(open('LogReg_dist_angle_model.pkl','rb'))
...
estimators = [('lgbm',lgbm),('nn',nn),('xgb',xgb),('logreg',logreg)]
...
experiment.add_tag('6-4 Stacked trained')
