...
def load_data(features: List[str], train_val_seasons: List[str] = None, test_season: List[str] = None,
    ...
    :param train_val_seasons: List of seasons to be used for the train & val sets. Default: ['20162017', '20172018',
     '20182019', '20192020']
    :param test_season: List of seasons to be used for the test set. Default: ['20202021']
    ...
    if train_val_seasons is None:
        train_val_seasons = ['20162017', '20172018', '20182019', '20192020']
    if test_season is None:
        test_season = ['20202021']
