    ...
    def ping_api(self):
        ...
        if first_request:
            ...
            with open(self.file_path, 'w') as f:
                ...
                game_data = add_shot_distance_feature(game_data)
                game_data = add_shot_angle(game_data)
                game_data = add_change_in_shot_angle(game_data)
